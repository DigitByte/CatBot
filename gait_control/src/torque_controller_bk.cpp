...
void torqueController::computeForces(){
    ...
    */
    ...
    if(this->stance_fl){
        ...
        A.block<3,3>(0,3*offset_feet) = -Eigen::MatrixXf::Identity(3, 3);
        A.block<3,3>(3,3*offset_feet) = -vect_mat_fl;
    ...
    if(this->stance_fr){
        ...
        A.block<3,3>(0,3*offset_feet) = -Eigen::MatrixXf::Identity(3, 3);
        A.block<3,3>(3,3*offset_feet) = -vect_mat_fr;
    ...
    if(this->stance_bl){
        ...
        A.block<3,3>(0,3*offset_feet) = -Eigen::MatrixXf::Identity(3, 3);
        A.block<3,3>(3,3*offset_feet) = -vect_mat_bl;
    ...
    if(this->stance_br){
        ...
        A.block<3,3>(0,3*offset_feet) = -Eigen::MatrixXf::Identity(3, 3);
        A.block<3,3>(3,3*offset_feet) = -vect_mat_br;
    ...
    B << (ROBOT_TOTAL_MASS * des_acc.x()),
         (ROBOT_TOTAL_MASS * des_acc.y()),
         (ROBOT_TOTAL_MASS * des_acc.z()),
         rot_dynamics.x(),//(ROBOT_INERTIA_XX* des_ang_vel.x() + ROBOT_INERTIA_XY* des_ang_vel.y() + ROBOT_INERTIA_XZ* des_ang_vel.z()),
         rot_dynamics.y(),//(ROBOT_INERTIA_XY* des_ang_vel.x() + ROBOT_INERTIA_YY* des_ang_vel.y() + ROBOT_INERTIA_YZ* des_ang_vel.z()),
         rot_dynamics.z();//(ROBOT_INERTIA_XZ* des_ang_vel.x() + ROBOT_INERTIA_YZ* des_ang_vel.y() + ROBOT_INERTIA_ZZ* des_ang_vel.z());
