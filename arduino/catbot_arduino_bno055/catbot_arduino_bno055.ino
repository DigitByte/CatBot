...
ros::ServiceServer<catbot_msgs::set_motor_calibration::Request, catbot_msgs::set_motor_calibration::Response> setMotorCalServer("catbot_muscular/set_motor_calibration",&setMotorCalCB);
ros::ServiceServer<catbot_msgs::connect_servos::Request, catbot_msgs::connect_servos::Response> connectServosServer("catbot_muscular/connect_servos",&connectServosCB);


/************************ ROS SUBSCRIBERS ************************/

ros::Subscriber<sensor_msgs::JointState> jointControlSub("catbot_muscular/joints_control", &jointControlCB );
...
ros::Publisher IMUStatePub("catbot_muscular/imu_data",       &imu_state);
ros::Publisher freqInfoPub("catbot_muscular/driver_freq",    &loop_freq);
ros::Publisher contactDetectionPub("catbot_muscular/contact_detection",    &feet_contact_detector);
